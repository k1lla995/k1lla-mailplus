...
const premKey = {
	'email:delete': ['/email/delete', '/email/restore', '/email/permanent', '/email/recycle'],
	...
	'setting:set': ['/setting/set', '/setting/setBackground', '/setting/deleteBackground', '/setting/setPwaIcon', '/setting/deletePwaIcon', '/setting/setBlacklist'],
...
app.use('*', async (c, next) => {
	...
	if (permIndex > -1) {
		...
		if (userPermIndex === -1 && !adminUtils.isAdminUser(authInfo.user, c.env.admin)) {
