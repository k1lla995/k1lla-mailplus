const en = {
    ...
    searchByEmail: 'Search by email or user ID',
    ...
    runnerResumeHint: 'Click the game to continue',
    ...
    websiteTitle: 'Title',
    pwaInstallIcon: 'PWA Install Icon',
    pwaInstallIconDesc: 'Uploads are center-cropped to 512 × 512 for the browser install prompt.',
    pwaInstallIconError: 'The icon could not be processed or uploaded. Please try another image.',
    resetPwaInstallIconConfirm: 'Restore the default pet icon?',
    ...
    loginGameDesc: 'Allow visitors to resize the game on the login page.',
    liquidGlass: 'Liquid Glass',
    liquidGlassDesc: 'Give the login runner an adaptive macOS-style vibrancy effect',
    emailSetting: 'Email',
    ...
    searchAttachmentFormat: 'For example: .pdf, .docx, .zip',
