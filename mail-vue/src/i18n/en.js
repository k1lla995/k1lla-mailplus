const en = {
    ...
    translationLoadModels: 'Load models from provider',
    translationNoModels: 'Provider returned no models',
    translationModelsFailed: 'Unable to load models from provider',
